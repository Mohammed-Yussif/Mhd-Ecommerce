  ...
  <div class="card-body">
    <form class="needs-validation" novalidate id="app-form"
      ...
      <div class="wp-500 m-auto">
        <x-common-form-input title="Taxes" name="name" value="{{ old('name', $tax_rate->name) }}" required placeholder="Taxes" />
        ...
        <x-common-form-select title="area" :empty-option="false" name="region_id" :options="$regions" key="id" label="name"
