  ...
  <div class="card-body">
    <form class="needs-validation" novalidate id="app-form"
      ...
      <div class="wp-500 m-auto">
        ...
        <x-common-form-input title="describe" name="description" value="{{ old('description', $tax_class->description) }}" required placeholder="describe" />
        <x-panel::form.row title="rule" required>
          @php ($index = 0)
