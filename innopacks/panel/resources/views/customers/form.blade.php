      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="needs-validation" novalidate id="app-form"
            ...
            <x-common-form-image title="avatar" name="avatar" value="{{ old('avatar', $customer->avatar) }}" required/>

            <x-common-form-input title="Email" name="email" value="{{ old('email', $customer->email) }}" required
                                 placeholder="Email"/>

            <x-common-form-input title="name" name="name" value="{{ old('name', $customer->name) }}" required
                                 placeholder="name"/>

            <x-common-form-input title="source" name="from" value="{{ old('from', $customer->from) }}"
                                 placeholder="source"/>

            <x-common-form-select title="User Groups" name="customer_group_id" :options="$groups" key="id" label="name"
                                  value="{{ old('customer_group_id', $customer->customer_group_id) }}"/>

            <x-common-form-select title="language" name="locale" :options="$locales" key="code" label="name"
