    ...
    <el-drawer v-model="drawer" size="500" @close="close">
      ...
      >
        ...
        <el-form-item label="coding" prop="code">
          <el-input v-model="form.code" placeholder="coding"></el-input>
        </el-form-item>
        ...
        <el-form-item label="Sorting" prop="position">
          <el-input v-model="form.position" placeholder="Sorting"></el-input>
        </el-form-item>

        <el-form-item label="state" prop="active">
