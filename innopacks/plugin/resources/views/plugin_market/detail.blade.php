            ...
            <div class="container py-0" id="marketItemsContent">
                    ...
                    <div class="col-md-9">
                      <div class="card-body px-0">
                        ...
                        @if($product['downloadable'])
                          <button class="btn btn-primary" type="button" id="btnDownload" data-product-type="plugin">Download Now</button>
                        @else
                          @include('plugin::shared._billing_method')
                          <button class="btn btn-danger" id="quickBuy" data-sku-id="{{$product['sku_id']}}"
                                  data-product-id="{{ $product['product_id'] }}" data-billing-method="">Buy it now
                          </button>
                        @endif
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="card shadow-sm border-0 p-2 p-md-4">
                  <h4 class="mb-4">Plugin Introduction</h4>
                  {!! $product['summary'] !!}
                </div>
              </div>
            </div>
