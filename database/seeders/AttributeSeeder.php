...
class AttributeSeeder extends Seeder
{
    ...
    {
        return [
            ['attribute_value_id' => 1, 'locale' => 'zh_cn', 'name' => 'Cotton'],
            ['attribute_value_id' => 1, 'locale' => 'en', 'name' => 'Cotton'],
            ['attribute_value_id' => 2, 'locale' => 'zh_cn', 'name' => 'Numb'],
            ['attribute_value_id' => 2, 'locale' => 'en', 'name' => 'Numb'],
            ['attribute_value_id' => 5, 'locale' => 'en', 'name' => 'Silk'],
            ['attribute_value_id' => 5, 'locale' => 'zh_cn', 'name' => 'Silk'],
            ['attribute_value_id' => 6, 'locale' => 'en', 'name' => 'Hair'],
            ['attribute_value_id' => 6, 'locale' => 'zh_cn', 'name' => 'Hair'],
            ['attribute_value_id' => 7, 'locale' => 'zh_cn', 'name' => 'Chemical fiber'],
            ['attribute_value_id' => 7, 'locale' => 'en', 'name' => 'Chemical fiber'],
            ['attribute_value_id' => 4, 'locale' => 'zh_cn', 'name' => 'Round neck'],
            ['attribute_value_id' => 4, 'locale' => 'en', 'name' => 'Round neck'],
            ['attribute_value_id' => 8, 'locale' => 'en', 'name' => 'Collarless'],
            ['attribute_value_id' => 8, 'locale' => 'zh_cn', 'name' => 'Collarless'],
            ['attribute_value_id' => 9, 'locale' => 'en', 'name' => 'Short sleeve'],
            ['attribute_value_id' => 9, 'locale' => 'zh_cn', 'name' => 'Short sleeve'],
            ['attribute_value_id' => 10, 'locale' => 'zh_cn', 'name' => 'T-shirt'],
            ['attribute_value_id' => 10, 'locale' => 'en', 'name' => 'T-shirt'],
            ['attribute_value_id' => 3, 'locale' => 'zh_cn', 'name' => 'Water proof'],
            ['attribute_value_id' => 3, 'locale' => 'en', 'name' => 'Water proof'],
            ['attribute_value_id' => 11, 'locale' => 'zh_cn', 'name' => 'keep warm'],
            ['attribute_value_id' => 11, 'locale' => 'en', 'name' => 'keep warm'],
            ['attribute_value_id' => 12, 'locale' => 'zh_cn', 'name' => 'Sun protection'],
            ['attribute_value_id' => 12, 'locale' => 'en', 'name' => 'Sun protection'],
            ['attribute_value_id' => 13, 'locale' => 'zh_cn', 'name' => 'Zoom Air Cushion'],
            ['attribute_value_id' => 13, 'locale' => 'en', 'name' => 'Zoom Air Cushion'],
            ['attribute_value_id' => 14, 'locale' => 'zh_cn', 'name' => 'Max Air Cushion'],
            ['attribute_value_id' => 14, 'locale' => 'en', 'name' => 'Max Air Cushion'],
            ['attribute_value_id' => 15, 'locale' => 'zh_cn', 'name' => 'Boost cushioning material'],
            ['attribute_value_id' => 15, 'locale' => 'en', 'name' => 'Boost cushioning material'],
            ['attribute_value_id' => 16, 'locale' => 'zh_cn', 'name' => 'Lightstrike Technology'],
            ['attribute_value_id' => 16, 'locale' => 'en', 'name' => 'Lightstrike Technology'],
            ['attribute_value_id' => 17, 'locale' => 'en', 'name' => 'Fuel Cell Technology'],
            ['attribute_value_id' => 17, 'locale' => 'zh_cn', 'name' => 'Fuel Cell Technology'],
